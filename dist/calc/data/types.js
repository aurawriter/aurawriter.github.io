...
var SV = (0, util_1.extend)(true, {}, XY, {
    ...
    Water: { Light: 1, Cosmic: 0.5 },
    Electric: { Light: 1, Cosmic: 1 },
    Ice: { Light: 1, Cosmic: 2 },
    Flying: { Light: 0.5, Cosmic: 1 },
    Bug: { Light: 1, Cosmic: 0.5 },
    Poison: { Light: 1, Cosmic: 1 },
    Ground: { Light: 1, Cosmic: 0.5 },
    Rock: { Light: 1, Cosmic: 1 },
    Fighting: { Light: 2, Cosmic: 1 },
    Psychic: { Light: 1, Cosmic: 2 },
    Ghost: { Light: 1, Cosmic: 1 },
    Dragon: { Light: 1, Cosmic: 1 },
    Dark: { Light: 0, Cosmic: 1 },
