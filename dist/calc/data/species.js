...
var SV_PATCH = {
    ...
    Artsenal: {
        types: ['Ground'],
        bs: { hp: 71, at: 75, df: 100, sa: 114, sd: 73, sp: 67 },
        weightkg: 108,
        heightm: 1.5,
        abilities: { 0: 'Regenerator' }
    },
    Mewgeosie: {
        types: ['Normal'],
        bs: { hp: 84, at: 91, df: 83, sa: 55, sd: 81, sp: 96 },
        weightkg: 43.8,
        heightm: 1.0,
        abilities: { 0: 'Fur Coat' }
    },
    Volaraptor: {
        types: ['Dragon'],
        bs: { hp: 64, at: 100, df: 60, sa: 85, sd: 50, sp: 131 },
        weightkg: 5,
        heightm: 1.3,
        abilities: { 0: 'Liftoff' }
    },
    Cirquite: {
        types: ['Flying'],
        bs: { hp: 68, at: 92, df: 57, sa: 97, sd: 56, sp: 120 },
        weightkg: 5,
        heightm: 1.3,
        abilities: { 0: 'Wind Rider' }
    },
    Snogre: {
        types: ['Ice'],
        bs: { hp: 65, at: 150, df: 78, sa: 142, sd: 59, sp: 47 },
        weightkg: 210,
        heightm: 2.1,
        abilities: { 0: 'Ice Body' }
    },
    Backterran: {
        types: ['Rock'],
        bs: { hp: 74, at: 115, df: 151, sa: 50, sd: 65, sp: 70 },
        weightkg: 220,
        heightm: 1.9,
        abilities: { 0: 'Sturdy' }
    },
    Embarin: {
        types: ['Fire'],
        bs: { hp: 60, at: 102, df: 50, sa: 102, sd: 50, sp: 121 },
        weightkg: 35,
        heightm: 1.2,
        abilities: { 0: 'Flame Body' }
    },
    Gilgagnash: {
        types: ['Fighting'],
        bs: { hp: 82, at: 123, df: 78, sa: 50, sd: 80, sp: 117 },
        weightkg: 85,
        heightm: 1.9,
        abilities: { 0: 'Intimidate' }
    },
    Googeous: {
        types: ['Poison'],
        bs: { hp: 120, at: 100, df: 125, sa: 40, sd: 75, sp: 30 },
        weightkg: 20.1,
        heightm: 1.0,
        abilities: { 0: 'Sticky Hold' }
    },
    Trampede: {
        types: ['Bug'],
        bs: { hp: 90, at: 135, df: 140, sa: 75, sd: 55, sp: 40 },
        weightkg: 62,
        heightm: 2.5,
        abilities: { 0: 'Steam Engine' }
    },
    Dapparition: {
        types: ['Ghost'],
        bs: { hp: 60, at: 125, df: 55, sa: 78, sd: 118, sp: 68 },
        weightkg: 4.4,
        heightm: 1.5,
        abilities: { 0: 'Keen Eye' }
    },
    Sweidel: {
        types: ['Steel'],
        bs: { hp: 75, at: 105, df: 115, sa: 60, sd: 35, sp: 125 },
        weightkg: 300,
        heightm: 2.5,
    ...
    Ladizwang: {
        types: ['Light'],
        bs: { hp: 90, at: 40, df: 110, sa: 100, sd: 110, sp: 40 },
        weightkg: 95,
        heightm: 1.8,
        abilities: { 0: 'Inner Focus' }
    },
    Lorzwang: {
        types: ['Dark'],
        bs: { hp: 90, at: 110, df: 40, sa: 110, sd: 40, sp: 100 },
        weightkg: 95,
        heightm: 1.8,
        abilities: { 0: 'Inner Focus' }
    },
    ...
    Lollibop: {
        types: ['Fairy', 'Fighting'],
        bs: { hp: 65, at: 75, df: 70, sa: 85, sd: 70, sp: 85 },
        weightkg: 5,
        heightm: 0.8,
        abilities: { 0: 'Sweet Veil' }
    },
    Cobrust: {
        types: ['Grass', 'Fire'],
        bs: { hp: 58, at: 80, df: 110, sa: 30, sd: 70, sp: 100 },
        weightkg: 65,
        heightm: 3.5,
        abilities: { 0: 'Shed Skin' }
    },
    Citrabell: {
        types: ['Grass'],
        bs: { hp: 45, at: 75, df: 70, sa: 55, sd: 60, sp: 85 },
        weightkg: 18,
        heightm: 0.7,
        nfe: true,
        abilities: { 0: 'Harvest' }
    ...
    Citrillon: {
        types: ['Grass'],
        bs: { hp: 55, at: 95, df: 95, sa: 65, sd: 70, sp: 110 },
        weightkg: 44,
        heightm: 1.5,
        abilities: { 0: 'Harvest' }
    },
    Peeltite: {
        types: ['Grass'],
        bs: { hp: 30, at: 55, df: 50, sa: 45, sd: 45, sp: 65 },
        weightkg: 5.8,
        heightm: 0.4,
        nfe: true,
        abilities: { 0: 'Harvest' }
    ...
    Lemurei: {
        types: ['Ghost', 'Normal'],
        bs: { hp: 91, at: 91, df: 44, sa: 44, sd: 44, sp: 102 },
        weightkg: 27.2,
        heightm: 0.7,
        abilities: { 0: 'Rattled' }
    }
